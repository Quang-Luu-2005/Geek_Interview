...
\nolinkurl{voucher_redemptions} & Per-user voucher usage and booking linkage \\
\nolinkurl{idempotency_records} & Logical request deduplication and response replay state \\
\nolinkurl{booking_status_history} & Operational audit trail for transitions \\
\bottomrule
\end{tabularx}
\end{table}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=0.86\textheight,keepaspectratio]{figures/erd.pdf}
